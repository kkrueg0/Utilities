...
{
	//An empty InputStream class for getFileContents() method.
	...
	*/
						...
						String encoding) throws IllegalArgumentException, IOException, UnsupportedEncodingException
	{
		...
		{
			String msg = "File size limit exceeded: ContentLength = "; 
			msg += this.intContentLength + " MaxReadBytes = " + this.intMaxContentLength;
				...
				else// (strFilename!=null)
				{
					...
					else // File uploaded, or at least a filename was specified, it could still be spurious.
					{
						...
						else// Read the file onto file system.
						{
							...
							{
								outFile = File.createTempFile("multPartReq", null, fileOutPutDirectory);
							}
	...
	*/
	public long readAndWriteFile(InputStream in, File outFile) throws IOException
	{
	...
	*/
	...
	private static final int getLengthMinusEnding(StringBuilder buf)
	{
	...
	*/
	...
	/**
	 * Returns the form field name of the first uploaded file
	 * @return
	 */
	public String getFirstFileParameterName()
	{
		Enumeration e = getFileParameterNames(); 
